...
namespace WindowsFormsApplication1
{
    public partial class Form1 : Form
    {
        ...
        public void marcar(Button sender)
        {

            if (sender.BackColor == Color.RoyalBlue)
            {
        ...
        private void button76_Click(object sender, EventArgs e)
        {
            ...
            {
                if (controlChotex is Button)
                    controlChotex.BackColor = Color.RoyalBlue;
                    controlChotex.ForeColor = Color.White;
            }
        }
